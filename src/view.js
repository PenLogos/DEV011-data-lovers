...
export const renderItems = (pokemon) => {
  ...
  if (pokemon.evolution && Array.isArray(pokemon.evolution['next-evolution']) && pokemon.evolution['next-evolution'][0] && pokemon.evolution['next-evolution'][0]['next-evolution']) {
  ...
  else if (pokemon.evolution && Array.isArray(pokemon.evolution['prev-evolution']) && pokemon.evolution['prev-evolution'][0] && pokemon.evolution['next-evolution']&&['prev-evolution']) {
  ...
  else if (pokemon.evolution && Array.isArray(pokemon.evolution['prev-evolution']) && pokemon.evolution['prev-evolution'][0] && Array.isArray(pokemon.evolution['prev-evolution'][0]['prev-evolution'])) {
